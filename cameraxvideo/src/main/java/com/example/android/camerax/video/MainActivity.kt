...
import com.example.android.camerax.video.databinding.ActivityMainXvideoBinding

class MainActivity : AppCompatActivity() {

    private lateinit var activityMainBinding: ActivityMainXvideoBinding

    @SuppressLint("SourceLockedOrientationActivity")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        activityMainBinding = ActivityMainXvideoBinding.inflate(layoutInflater)
